...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3592.1095474762064; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1821.3730577954693; // x position of the perpendicular encoder (in tick units)
    }
